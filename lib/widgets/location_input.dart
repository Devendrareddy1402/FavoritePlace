...
class _LocationInputState extends State<LocationInput> {
  ...
  String get locationImage {
    ...
    return 'https://maps.googleapis.com/maps/api/staticmap?center=$lat,$long&zoom=16&size=600x300&maptype=roadmap&markers=color:red%7Clabel:A%7C$lat,$long&key=API-KEY';
  }
  ...
  void _getCurrentLocation() async {
    ...
    final url = Uri.parse(
      'https://maps.googleapis.com/maps/api/geocode/json?latlng=$lat,$long&key=API-KEY',
    );
